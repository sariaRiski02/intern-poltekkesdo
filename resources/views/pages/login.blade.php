    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-md mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-600">Program Poltekkes Manado</p>
            </div>
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-emerald-100">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('login') }}"
                            ...
                            {{ request()->routeIs('login') ? 'bg-gradient-to-r from-emerald-500 to-blue-500 text-white border-transparent shadow-lg' : 'bg-white/50 text-slate-600 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50' }}"
                        >
                        ...
                        <a href="{{ route('admin.login') }}"
                            class="flex-1 py-3 px-4 text-sm font-medium rounded-xl border-2 transition-all duration-300
                            {{ request()->routeIs('admin.login') ? 'bg-gradient-to-r from-emerald-500 to-blue-500 text-white border-transparent shadow-lg' : 'bg-white/50 text-slate-600 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50' }}"
                        >
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form method="POST" action="{{ request()->routeIs('admin.login') ? route('admin.login') : route('login') }}">
                    ...
                    <!-- Hidden Role Field berdasarkan route -->
                    <input type="hidden" name="role" value="{{ request()->routeIs('admin.login') ? 'admin' : 'intern' }}">
