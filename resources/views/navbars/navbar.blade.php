            ...
            @auth
              <div class="flex items-center gap-3">
                ...
                <form action="" method="POST" class="inline">
                  @csrf
                  <a href="{{ route('logout') }}" type="submit" class="cursor-pointer bg-gradient-to-r from-red-500 to-rose-500 text-white font-bold px-4 py-2 rounded-lg shadow hover:from-red-600 hover:to-rose-600 transition-all border-2 border-red-600 hover:border-rose-600">
                      Logout
                  </a>
                </form>
              </div>
