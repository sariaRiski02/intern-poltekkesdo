...
Route::middleware([visitorMiddleware::class])->group(function () {
    ...
    Route::middleware([loggedInMiddleware::class])->group(function () {
        ...
        Route::post('/login', [AuthController::class, 'login_intern_process'])->name('login-process');
        Route::get('/register', [AuthController::class, 'register'])->name('register');
        Route::post('/register', [AuthController::class, 'register_intern_process'])->name('register-process');
    });
    ...
    Route::get('/logout', [AuthController::class, 'logout'])->middleware([loggedInMiddleware::class])->name('logout');
});
